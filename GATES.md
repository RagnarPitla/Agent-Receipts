...
- [x] G1: a ticked box with no evidence is counted as unmet, not as done
  ...
  EVIDENCE: proven | exit=0 | expect=matched | shell=/bin/sh | cwd=/Users/ragnarpitla/Desktop/rbuild-ai/CS-2026/Agent-Receipts | path=bb1a299c0c7a (38 entries) | ms=36 | output=sha256:f335cf77bbc40fcc bytes=332 | at=2026-08-31T03:43:10.053Z
...
- [x] G2: a deploy that reports success and creates nothing is caught
  ...
  EVIDENCE: proven | exit=0 | expect=matched | shell=/bin/sh | cwd=/Users/ragnarpitla/Desktop/rbuild-ai/CS-2026/Agent-Receipts | path=bb1a299c0c7a (38 entries) | ms=202 | output=sha256:59d0ce2653fc94be bytes=302 | at=2026-08-31T03:43:10.257Z
...
- [x] G3: every shape of a check that cannot fail is still flagged
  ...
  EVIDENCE: proven | exit=0 | expect=matched | shell=/bin/sh | cwd=/Users/ragnarpitla/Desktop/rbuild-ai/CS-2026/Agent-Receipts | path=bb1a299c0c7a (38 entries) | ms=35 | output=sha256:333b71a6521089e2 bytes=24 | at=2026-08-31T03:43:10.293Z
...
- [x] G4: a gate that is already ticked is re-run, so a stale pass cannot survive
  ...
  EXPECT: - [ ] A1: stale
  EVIDENCE: proven | exit=0 | expect=matched | shell=/bin/sh | cwd=/Users/ragnarpitla/Desktop/rbuild-ai/CS-2026/Agent-Receipts | path=bb1a299c0c7a (38 entries) | ms=60 | output=sha256:0d92746880a2710c bytes=16 | at=2026-08-31T03:43:10.353Z
...
- [x] G5: a gate that could not be run is never reported as met
  ...
  EVIDENCE: proven | exit=0 | expect=matched | shell=/bin/sh | cwd=/Users/ragnarpitla/Desktop/rbuild-ai/CS-2026/Agent-Receipts | path=bb1a299c0c7a (38 entries) | ms=45 | output=sha256:f267c991db7a921d bytes=43 | at=2026-08-31T03:43:10.398Z
...
- [x] R1: the test suite passes
  ...
  EVIDENCE: proven | exit=0 | expect=matched | shell=/bin/sh | cwd=/Users/ragnarpitla/Desktop/rbuild-ai/CS-2026/Agent-Receipts | path=bb1a299c0c7a (38 entries) | ms=754 | output=sha256:be64a1ff858e9c6c bytes=20 | at=2026-08-31T03:43:11.153Z
...
- [x] R2: it works from a clean clone with nothing installed
  ...
  EXPECT: 37 passed, 0 failed
  EVIDENCE: proven | exit=0 | expect=matched | shell=/bin/sh | cwd=/Users/ragnarpitla/Desktop/rbuild-ai/CS-2026/Agent-Receipts | path=bb1a299c0c7a (38 entries) | ms=1055 | output=sha256:be64a1ff858e9c6c bytes=20 | at=2026-08-31T03:43:12.209Z
...
- [x] S1: no probe can write to an environment
  ...
  EVIDENCE: proven | exit=0 | expect=matched | shell=/bin/sh | cwd=/Users/ragnarpitla/Desktop/rbuild-ai/CS-2026/Agent-Receipts | path=bb1a299c0c7a (38 entries) | ms=11 | output=sha256:ad4f35cecc877748 bytes=50 | at=2026-08-31T03:43:12.222Z
...
- [x] S2: there is no runtime dependency tree to audit
  ...
  EVIDENCE: proven | exit=0 | expect=matched | shell=/bin/sh | cwd=/Users/ragnarpitla/Desktop/rbuild-ai/CS-2026/Agent-Receipts | path=bb1a299c0c7a (38 entries) | ms=26 | output=sha256:12a5d2f7f8b9c13f bytes=27 | at=2026-08-31T03:43:12.249Z
...
- [x] S3: an approval store inside the repository is refused
  ...
  EVIDENCE: proven | exit=0 | expect=matched | shell=/bin/sh | cwd=/Users/ragnarpitla/Desktop/rbuild-ai/CS-2026/Agent-Receipts | path=bb1a299c0c7a (38 entries) | ms=35 | output=sha256:61311f99ca066890 bytes=229 | at=2026-08-31T03:43:12.285Z
...
- [x] L1: no gate in this file is closed by a check that cannot fail
  ...
  EVIDENCE: proven | exit=0 | expect=matched | shell=/bin/sh | cwd=/Users/ragnarpitla/Desktop/rbuild-ai/CS-2026/Agent-Receipts | path=bb1a299c0c7a (38 entries) | ms=51 | output=sha256:8bb92e131a1176b4 bytes=25 | at=2026-08-31T03:43:12.337Z
...
- [x] L2: the published page is valid and still matches its generator
  ...
  EVIDENCE: proven | exit=0 | expect=matched | shell=/bin/sh | cwd=/Users/ragnarpitla/Desktop/rbuild-ai/CS-2026/Agent-Receipts | path=bb1a299c0c7a (38 entries) | ms=106 | output=sha256:19348f13756faa7e bytes=22 | at=2026-08-31T03:43:12.444Z
...
- [ ] E1: the probes have been run against a live Copilot Studio environment and the transcript published
  ...
  EXPECT: PROOF OK
  EVIDENCE: pending (last attempt: FAILED | exit=2 | expect=not found | shell=/bin/sh | cwd=/Users/ragnarpitla/Desktop/rbuild-ai/CS-2026/Agent-Receipts | path=bb1a299c0c7a (38 entries) | ms=10 | at=2026-08-31T03:43:12.454Z)
